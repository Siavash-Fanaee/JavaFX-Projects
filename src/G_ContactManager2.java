...
public class G_ContactManager2 extends Application {
	...
	public G_ContactManager2() {

		lblNames = new Label("Contact Names:");
	...
	public void init() {
		...
		btnAbout.setOnAction(ae -> {
			...
			alert.setContentText("HDC 20-21, GCD, GUI&UI-JavaFX.");
