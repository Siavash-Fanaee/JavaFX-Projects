...
public class Inheritance_Vehicle_Main extends Application {
	
	Inheritance_Vehicle v;
	...
	public Inheritance_Vehicle_Main() {
	...
	private void createInstance() {
		...
		if (registerNumber==null) {
			...
			if (rbTrauck.isSelected()) {
				...
				v = new Inheritance_Truck(registerNumber);
			...
			if (rbCar.isSelected()) {
				...
				v = new Inheritance_Car(registerNumber);
				v.setColer(cb.getSelectionModel().getSelectedItem().toString());			
				v.setMake(txtfMake.getText());
				v.setModel(txtfModel.getText());
